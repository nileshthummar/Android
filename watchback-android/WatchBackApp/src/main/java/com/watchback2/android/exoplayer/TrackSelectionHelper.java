 ...
 */
package com.watchback2.android.exoplayer;
  ...
  private View buildView(Context context) {
    ...
    for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
      ...
      for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
        ...
        String strName = DemoUtil.buildTrackName(group.getFormat(trackIndex));
        trackView.setText(strName);
        ...
        if (!strName.equalsIgnoreCase("unknown")){

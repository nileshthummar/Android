...
public class SingleChannelWithVideoResponseModel extends Data {


    @Expose
    @SerializedName("videos")
    private List<BrightcovePlaylistData.BrightcoveVideo> mVideos;
    @Expose
    @SerializedName("link")
    ...
    public String getDetailsScreenLogoUrl() {
